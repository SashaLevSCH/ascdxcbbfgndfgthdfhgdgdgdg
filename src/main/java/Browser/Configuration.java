...
public class Configuration {
   ...
   // public static final String HEALTH_CARE_GOV_URL = getValue("healthcaregovurl");

    public static final String YOPMAIL_URL = getValue("yopmailurl");
    public static final String grp_url = getValue("grpurl");
    public static final String AdminLoginURL =getValue("adminloginPage");
